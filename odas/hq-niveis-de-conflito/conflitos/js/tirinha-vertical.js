...
$(function () {
    var hqTED = function (el, path) {
        ...
        $(el).each(function (index, element) {
            ...
            console.log("hq_id:", hq_id, "hq_radical:", hq_radical, "hq_quadro_inicio:", hq_quadro_inicio, "hq_quadro_fim:", hq_quadro_fim);
    ...
    hqTED(".hq", "../odas/hq-niveis-de-conflito/conflitos/img")
